...
# getData.R
#
# useful data and file routines for getting data for plotting

fetchFile <- function(srcURL, fileName, dataDir = "./data") {
...
courseData <- function() {
  ...
  get <- function() {
    ...
    archive <- fetchFile(src, zipFile, "./data")
    input <- extractFile(archive, txtFile, "./data")
